<template>
  <div class="article-list">
    <div v-for="article in myArticles" :key="article.id" class="article-card" @click="goToArticleDetail(article.articleNo)">
...
export default {
  ...
  created() {
    ...
    axios({
      ...
      method: 'get',
      url: `http://localhost:9999/api-article/articles/${userNo}`,
      responseType: 'json'
    }).then((response) => {
